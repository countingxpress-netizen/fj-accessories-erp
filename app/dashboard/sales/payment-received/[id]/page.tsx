    ...
    <div>
      ...
      <div className="flex items-center justify-between mt-2 mb-4">
        ...
        <div className="flex gap-2">
          <Link href={`/dashboard/sales/payment-received/${id}/edit`} className="rounded-lg bg-gray-900 px-4 py-2 text-sm text-white">Edit</Link>
          <PaymentActions paymentId={id} voucherId={payment.voucher_id} />
        </div>
      </div>
