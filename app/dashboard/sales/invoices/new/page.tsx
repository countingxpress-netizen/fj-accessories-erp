...
export default async function NewSalesInvoicePage() {
  ...
  const { data: bookings } = await supabase
    .from("bookings")
    .select("id, booking_no, quantity_pcs, product_id, customer_id, style, buyers(name), merchants(name), delivery_point, customer_booking_ref, has_print, print_colors, measurement_type, width_val, measurement_unit, finished_goods(product_name, length_cm, width_cm, thickness)")
