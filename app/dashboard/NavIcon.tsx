// সাইডবারের ছোট stroke আইকন সেট (inline SVG — কোনো লাইব্রেরি নয়, CSP-নিরাপদ)।
// server ও client দুই জায়গা থেকেই ব্যবহারযোগ্য (কোনো hook নেই)।
...
const PATHS: Record<string, ReactNode> = {
  ...
  purchase: (
    <>
      ...
      <path d="M2 2h2l2.6 12.4a2 2 0 0 0 2 1.6h9.7a2 2 0 0 0 2-1.6L23 6H5" />
    </>
  ),
  sales: (
    <>
      <path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z" />
      <path d="M15 8h-5a2 2 0 0 0 0 4h3a2 2 0 0 1 0 4H8" />
      <path d="M12 6v12" />
    </>
  ),
  production: (
